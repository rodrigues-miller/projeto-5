      program main
        ...
        mt = 1/(3*10**5)
        !vxt é valor da componente x da velocidade inicial da Terra.
        vxt = 0.d0
        !vyt é valor da componente y da velocidade inicial da Terra.
        vyt = 2*pi
        !vxj é o valor da componente x da velocidade inicial de Júpiter.
        vxj = 0.d0
        !vyj é o valor da componente y da velocidade inical de Júpiter.
        vyj = dsqrt(4*pi**2/5.2)
        !vxs é o valor da componente x da velocidade inical do Sol.
        vxs = 0.d0
        !vys é valor da componente y da velocidade inical do Sol.
        vys = 0.d0
        ...
        open(3,file='saída-2-tarefa-B1.')
        open(4,file='saída-3-tarefa-B1.')
        open(5,file='saída-4-tarefa-B1.')
        ...
        !Terra e Júpiter, para o sol fixo no ponto (0,0).
     ...
     &vys,x_1t,y_1t,x_1j,y_1j,x_1s,y_1s,mj)
        ...
        !componente x e y para a componente y. A última letra é 
        !referente ao astro, sendo t a Terra, j Júpiter e s o Sol.
        open(2,file='saída-5-tarefa-B1.')
        open(3,file='saída-6-tarefa-B1.')
        open(4,file='saída-7-tarefa-B1.')
        open(5,file='saída-8-tarefa-B1.')
        open(6,file='saída-9-tarefa-B1.')
        !Atribuindo o valor inicial da distância dos planetas em
        !relação ao ponto (0,0) em cada componente, sendo x para a 
        !componente x e y para a componente y. A última letra é 
        !referente ao astro, sendo t a Terra, j Júpiter e s o Sol.
        ...
        !está sofrendo efeitos gravitacionais dos os planetas).
